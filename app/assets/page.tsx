...
type Query = { organizationId?: string; plantId?: string; search?: string; assetClassId?: string; familyId?: string; zoneId?: string; status?: string; criticality?: string; view?: string; page?: string };
...
export default async function AssetsPage({ searchParams }: { searchParams: Promise<Query> }) {
  ...
  const [assets, assetClasses, families, zones, total, underRepair, critical] = await Promise.all([
