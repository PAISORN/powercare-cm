    ...
    <AppShell>
      <div className="space-y-5">
        ...
        <section className="rounded-3xl border border-[var(--line)] bg-[var(--surface)] p-4 shadow-[var(--shadow)]">
          <form action="/dashboardstore/spare-parts" className="grid gap-3 lg:grid-cols-[1fr_1fr_1fr_auto]" method="get">
            <ScopeInfo
        ...
        >
          ...
          <form action="/dashboardstore/spare-parts" className="mx-5 mb-5 grid gap-3 rounded-2xl border border-[var(--line)] bg-[var(--soft)] p-4 sm:mx-6 lg:grid-cols-3 xl:grid-cols-6" method="get">
            ...
            <section className="mt-6 border-t border-[var(--line)] pt-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                {!editPart.stocks.length && canReceiveStock ? (
                  <Link className={secondaryButtonClass} href={`/dashboardstore/receive?organizationId=${encodeURIComponent(scope.organization.id)}&plantId=${encodeURIComponent(scope.plant.id)}`}>
