  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative grid size-10 place-items-center rounded-full border border-[var(--line)] bg-[var(--surface)] text-[var(--ink)] shadow-sm transition hover:bg-[var(--soft)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
